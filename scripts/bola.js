class Bola{
    constructor(c, pad){
        ...
        this.bolinha.width=30;
        this.bolinha.height=30;
    ...
    management(){
        ...
        if (this.movendo){ 
            ...
            && ((this.y + this.altura >= this.pad.y) && (this.y <= this.pad.altura+ this.pad.y)))
             ...
             if ((this.x <= this.pad.x + this.pad.largura) && (this.x + this.largura >=
             this.pad.x)
              && ((this.y + this.altura >= this.pad.y)&&(this.y <= this.pad.altura + this.pad.y)))
              {
                 this.dirX = 1;
                 this.dirY = ((this.y +  (this.altura/2))-(this.pad.y + (this.pad.
                    altura/2)))/16;
